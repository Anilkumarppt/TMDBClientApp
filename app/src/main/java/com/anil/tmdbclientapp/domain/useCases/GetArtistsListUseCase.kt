...
class GetArtistsListUseCase @Inject constructor(private val artistsRepository: ArtistsRepository) {

    suspend fun execute():List<Artist>?= artistsRepository.getPopularArtists()
}